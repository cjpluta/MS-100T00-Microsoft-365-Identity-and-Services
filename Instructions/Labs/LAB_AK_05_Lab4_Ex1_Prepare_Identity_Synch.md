...
3. On the **Microsoft - IdFix** window, under the **Step 2: Install IdFix** section at the top of the page, the instructions direct you to run **setup.exe** to install the IdFix application on your machine. Select **setup.exe** to download the file to LON-DC1. 
